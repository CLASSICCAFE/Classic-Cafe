...
CREATE TABLE IF NOT EXISTS menu_items(id TEXT PRIMARY KEY,name TEXT NOT NULL UNIQUE,category TEXT,available INTEGER DEFAULT 1,updated_at TEXT NOT NULL);
